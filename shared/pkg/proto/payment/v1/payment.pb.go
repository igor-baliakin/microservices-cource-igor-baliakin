...
const (
	PaymentMethod_PAYMENT_METHOD_UNSPECIFIED    PaymentMethod = 0 // Default value
	PaymentMethod_PAYMENT_METHOD_CARD           PaymentMethod = 1 // Credit card payment
	PaymentMethod_PAYMENT_METHOD_SBP            PaymentMethod = 2 // SBP payment
	PaymentMethod_PAYMENT_METHOD_CREDIT_CARD    PaymentMethod = 3 // Credit card payment
	PaymentMethod_PAYMENT_METHOD_INVESTOR_MONEY PaymentMethod = 4 // Investor money  payment
)
...
// Request message for PayOrder method
type PayOrderRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OrderUuid     string                 `protobuf:"bytes,1,opt,name=order_uuid,json=orderUuid,proto3" json:"order_uuid,omitempty"`                                            // UUID of the order to be paid
	UserUuid      string                 `protobuf:"bytes,2,opt,name=user_uuid,json=userUuid,proto3" json:"user_uuid,omitempty"`                                               // UUID of the user making the payment
	PaymentMethod PaymentMethod          `protobuf:"varint,3,opt,name=payment_method,json=paymentMethod,proto3,enum=payment.v1.PaymentMethod" json:"payment_method,omitempty"` // Payment method
...
// Response message for PayOrder method
type PayOrderResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	TransactionUuid string                 `protobuf:"bytes,1,opt,name=transaction_uuid,json=transactionUuid,proto3" json:"transaction_uuid,omitempty"` // UUID of the transaction
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseBdZbgithub.com/igor-baliakin/microservices-cource-igor-baliakin/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
